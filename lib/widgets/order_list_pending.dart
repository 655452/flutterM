...
class _OrdersState extends State<Orders> {
  ...
  String completedDialogue = "Are you sure you want to completed the order?";
  ...
  String DialogueCompleted = "Order Completed?";
                                              ...
                                              child: ElevatedButton(
                                                style: ElevatedButton.styleFrom(
                                                  ...
                                                  foregroundColor: Colors
                                                      .white, backgroundColor: Colors.red, // foreground
                                                  shape: RoundedRectangleBorder(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            10), // <-- Radius
                                            ...
                                            Container(
                                                    ...
                                                    child: ElevatedButton(
                                                      ...
                                                      onPressed: () async {
                                                         ...
                                                         if(orders.orderList[index].orderType == 1){
                                                           showAlertDialog(
                                                               context,
                                                               DialogueProcess,
                                                               processDialogue,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                                orders.orderList[index].orderTypeName
                                                    .toString(),
                                            style: TextStyle(
                                              color:
